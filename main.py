...
def select_excel_file(event):
    ...
    file_path = filedialog.asksaveasfilename(defaultextension='.xlsx', initialfile=default_file_name, filetypes=[("Excel Files", "*.xlsx")])
...
canvas.create_text( 180.0, 115.0, anchor="nw", text="Метод ПУЗ-ОРХ", fill="#FFFFFF", font=("RalewayRoman SemiBold", 48 * -1))
...
canvas.create_text( 298.0, 569.0, anchor="nw", text="Загрузить", fill="#FFFFFF", font=("PlusJakartaSansRoman ExtraBold", 24 * -1))
...
canvas.create_text( 120.0, 614.0, anchor="nw", text="Пожалуйста, выберите где вы хотите сохранить файл", fill="#82819D", font=("Inter Medium", 20 * -1))
